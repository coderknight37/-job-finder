    ...
    <div class="mb-4 shadow card">
        ...
        <div class="card-body">
                <div class="form-group">
                  ...
                  <input  value="{{ $user->name }}" name="name" type="name" class="form-control" id="exampleInputEmail1">
                ...
                <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <select style="font-weight: bolder" class="form-control" name="science">
                    <option value="{{ $user->scientific_degree_id }}">{{ $user->scientific_degree->name }} (Chosen)</option>
