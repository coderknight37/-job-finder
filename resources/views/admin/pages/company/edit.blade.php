    ...
    <div class="mb-4 shadow card">
        ...
        <div class="card-body">
                <div class="form-group">
                  ...
                  <input name="name" value="{{ $company->name }}" type="name" class="form-control" id="exampleInputEmail1">
                  <small id="emailHelp" class="form-text text-muted">Insert your name.</small>
                </div>
                <div class="form-group">
                    <label for="exampleInputEmail1">Email address</label>
                    <input name="email" value="{{ $company->email }}" type="email" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
                    <small id="emailHelp" class="form-text text-muted">We'll never share your email with anyone else.</small>
                  </div>
                  <div class="form-group">
                    <label for="exampleInputEmail1">Address</label>
                    <input name="address" value="{{ $company->address }}" type="name" class="form-control" id="exampleInputEmail1">
                    <small id="emailHelp" class="form-text text-muted">Insert your address.</small>
                  </div>
                  <div class="form-group">
                    <label for="exampleInputEmail1">Password</label>
                    <input readonly name="password"  type="password" class="form-control" id="password" aria-describedby="emailHelp">
                    <button id="btnPassword" type="button" style="margin-top: 20px;" class="btn btn-success">Do you want to change the password</button>
                    <small id="emailHelp" class="form-text text-muted">We'll never share your email with anyone else.</small>
                  </div>
                  <div class="form-group">
                    <label for="exampleInputEmail1">website</label>
                    <input name="website" value="{{ $company->website }}" type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
                    <small id="emailHelp" class="form-text text-muted">We'll never share your email with anyone else.</small>
                  </div>
                  <div class="form-group">
                    <label for="exampleInputEmail1">Phone</label>
                    <input name="phone" value="{{ $company->phone }}" type="number" class="form-control" id="exampleInputEmail1">
                  ...
                  <div class="form-group">
                    ...
                    <input name="description" value="{{ $company->description }}" type="name" class="form-control" id="exampleInputEmail1">
...
@section("scripts")
    <script type="text/javascript">
        let password = document.querySelector("#btnPassword"),
